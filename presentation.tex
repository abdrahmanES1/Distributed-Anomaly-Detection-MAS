...
\author[A. ESSEBYITY  \& H. OUARIR ]{Abderrahman ESSEBYITY \and Hamza OUARIR}
...
\begin{frame}{Notre Solution: L'IA Distribuée Collaborative}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Validation par les Pairs}
        \begin{itemize}
...
\begin{frame}{Architecture du Système: Pipeline}
    \begin{figure}
        ...
        \node[component, fill=purple!15, draw=purple!60] (consensus) at (9,0) {3. Validation\\{\small P2P}};
...
\begin{frame}[fragile]{Validation par les Pairs en Action}
    \begin{columns}[c]
        ...
        \begin{column}{0.42\textwidth}
            ...
            {\small La validation filtre le bruit local !}
        \end{column}
    \end{columns}
\end{frame}
...
% ===============================
\begin{frame}{Impact de la Validation Distribuée}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{Sans Validation:}
            \begin{itemize}
        ...
        \begin{column}{0.48\textwidth}
            \textbf{Avec Validation:}
            \begin{itemize}
                \item Validation par les pairs
                \item Réduction aux faux positifs
...
% ===============================
\begin{frame}{Dashboard - Interface de Contrôle}
    \begin{center}
...
\begin{frame}{Conclusion et Perspectives}
    ...
    \begin{itemize}
        ...
        \item Validation Pair-à-Pair réduisant les faux positifs 
    ...
    \begin{itemize}
        ...
        \item Algorithmes ML plus sophistiqués
